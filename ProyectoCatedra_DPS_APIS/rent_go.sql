...
-- Tiempo de generación: 06-11-2023 a las 05:08:20
...
(6, 'Chevrolet', '2023-11-06 03:24:40');
...
CREATE TABLE IF NOT EXISTS `propietario` (
  ...
  `razonSocial` varchar(250) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `nombreComercial` varchar(250) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `correoElectronico` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `reserva` (
  ...
  `lugarEntrega` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `lugarDevolucion` text COLLATE utf8mb4_spanish_ci NOT NULL,
...
(1, 10, '7.50', '10.00', '10.00', 'Carro para 5 personas máximo, con seguro y poco kilometraje', 'Avenida España, San Salvador', 'Avenida España, San Salvador', 1, 1, '2023-11-06 04:18:47'),
(2, 15, '6.25', '7.50', '8.00', 'Carro para 6 personas máximo, con seguro y poco kilometraje', 'Boulevard del Ejército, Soyapango', 'Boulevard del Ejército, Soyapango', 1, 2, '2023-11-06 04:18:54'),
(3, 10, '5.25', '8.50', '10.00', 'Carro para 5 personas máximo, con seguro y poco kilometraje', 'San Salvador', 'San Salvador', 1, 3, '2023-11-06 04:20:26'),
(4, 12, '6.75', '9.50', '12.00', 'Bonito carro, con seguro, aire condicionado y demás detalles', 'Canton El Ojillo, Ahuachapan', 'Canton El Ojillo, Ahuachapan', 1, 4, '2023-11-06 04:22:56'),
(5, 15, '8.00', '6.50', '15.00', 'Carro en excelentes condiciones, ideal para viajes familiares', 'Zona Rosa', 'Zona Rosa', 1, 5, '2023-11-06 04:24:15');
...
(3, 'Hatchback', '2023-11-06 04:14:57');
...
CREATE TABLE IF NOT EXISTS `usuario` (
  `id` int NOT NULL AUTO_INCREMENT,
  `correoElectronico` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL,
  `contrasena` varchar(256) COLLATE utf8mb4_spanish_ci NOT NULL,
  `nombre` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL,
  `apellido` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL,
  `fechaNacimiento` date NOT NULL,
  `telefono` int NOT NULL,
  `imagenPerfil` varchar(250) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `codigoVerificacion` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `usuario_reserva` (
  ...
  `resena` text COLLATE utf8mb4_spanish_ci,
...
CREATE TABLE IF NOT EXISTS `vehiculo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `year` int NOT NULL,
  `color` varchar(100) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
(1, 2018, 'Negro', 'P195A5', 'https://drive.google.com/uc?export=view&id=1vMvF4QIrOzdWaiC0XGrR_OxVRZ8T3vpi', 5, '1.8 litros', 1, 1, 1, 2, 1, '2023-11-06 04:09:34'),
(2, 2021, 'Gris', 'P121097', 'https://drive.google.com/uc?export=view&id=1HZjRbtR5kY5xSxT7V3d6waTG-XOfmgPc', 5, '1.8 litros', 6, 2, 2, 2, 1, '2023-11-06 04:13:08'),
(3, 2018, 'Verde', 'P979D1C', 'https://drive.google.com/uc?export=view&id=1uU6dlmllNafeCmyk4-Tmhuay3qQHjQ3B', 4, '1.8 litros', 5, 1, 3, 1, 1, '2023-11-06 04:31:32'),
(4, 2016, 'Anaranjado', 'P49390', 'https://drive.google.com/uc?export=view&id=1O50cP4-jdKpIt2eHNzCuqaSeWAM5ZqiR', 2, '1.6 litros', 4, 3, 3, 2, 2, '2023-11-06 04:29:11'),
(5, 2019, 'Azul', 'P492349', 'https://drive.google.com/uc?export=view&id=1WMGKKqfIRp2YkR-bXeDz7HW6WNdYhw04', 5, '2.0 litros', 2, 2, 1, 1, 1, '2023-11-06 04:29:40');
